        ...
        default:
            ...
            switch(argument)
            {
                ...
                case "upToggle":case "downToggle":case "rightToggle":case "leftToggle":case "aToggle":case "bToggle":case "startToggle":case "selectToggle":
                    string button = argument.Remove(argument.Length - 6);
                    if(toggles[button])
                    {
                        gb.keyup(button);
